            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tambah Data Umum Koperasi Koperasi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Data Umum Koperasi</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= base_url('tambah-koperasi'); ?>" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <label class="bmd-label-floating">Nama Koperasi</label>
                                <input type="text" class="form-control" name="nama_koperasi" value="<?= set_value('nama_koperasi'); ?>" required>
                                <?= form_error('nama_koperasi', '<span class="text-danger small">', '</span>'); ?>
                            </div>
                            <div class="form-group">
                                <label class="bmd-label-floating">Nomor Badan Hukum</label>
                                <input type="text" class="form-control" name="nomor_badan_hukum" required value="<?= set_value('nomor_badan_hukum'); ?>">
                                <?= form_error('nomor_badan_hukum', '<span class="text-danger small">', '</span>'); ?>
                            </div>
                            <div class="form-group">
                                <label class="bmd-label-floating">Tanggal Badan Hukum</label>
                                <input type="date" class="form-control" name="tanggal_badan_hukum" required value="<?= set_value('tanggal_badan_hukum'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat" required value="<?= set_value('alamat'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ketua" required value="<?= set_value('ketua'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_hp_ketua" required value="<?= set_value('no_hp_ketua'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sekretaris" required value="<?= set_value('sekretaris'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_hp_sekretaris" required value="<?= set_value('no_hp_sekretaris'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="bendahara" required value="<?= set_value('bendahara'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_hp_bendahara" required value="<?= set_value('no_hp_bendahara'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="manajer_kasir" required value="<?= set_value('manajer_kasir'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_hp_manajer_kasir" required value="<?= set_value('no_hp_manajer_kasir'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jml_anggota_l" required value="<?= set_value('jml_anggota_l'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jml_anggota_p" required value="<?= set_value('jml_anggota_p'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jml_karyawan_l" required value="<?= set_value('jml_karyawan_l'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jml_karyawan_p" required value="<?= set_value('jml_karyawan_p'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="email" id="email" required value="<?= set_value('email'); ?>">
