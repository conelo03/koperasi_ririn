                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Simpanan</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= base_url('tambah-simpanan/'. $id_anggota); ?>" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <label class="bmd-label-floating">Tanggal Simpan</label>
                                <input type="date" class="form-control" name="tanggal_simpan" value="<?= set_value('tanggal_simpan', date('Y-m-d')); ?>" readonly>
                                <?= form_error('tanggal_simpan', '<span class="text-danger small">', '</span>'); ?>
                            </div>
                            <div class="form-group">
                                <label class="bmd-label-floating">Besar Simpanan</label>
                                <input type="number" class="form-control" name="besar_simpanan" value="<?= set_value('besar_simpanan'); ?>" required>
